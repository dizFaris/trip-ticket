    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,] {
                    { 1, 1, 4, new DateOnly(2025, 7, 1), new DateOnly(2025, 7, 10),
                        new DateOnly(2025, 7, 1).ToDateTime(TimeOnly.MinValue).AddDays(-3),
                        "Vacation", "Bus", 1200.50m, 100, 25, "A relaxing 10-day trip to Paris.",
                        new DateOnly(2025, 6, 20), 50m, 5, 10m, null, "upcoming", false, DateTime.UtcNow },

                    { 2, 7, 5, new DateOnly(2025, 8, 15), new DateOnly(2025, 8, 25),
                        new DateOnly(2025, 8, 15).ToDateTime(TimeOnly.MinValue).AddDays(-3),
                        "Historical", "Train", 800.00m, 50, 10, "Explore the ancient ruins and culture of Rome.",
                        null, null, null, null, null, "upcoming", false, DateTime.UtcNow },

                    { 3, 13, 15, new DateOnly(2025, 9, 5), new DateOnly(2025, 9, 15),
                        new DateOnly(2025, 9, 5).ToDateTime(TimeOnly.MinValue).AddDays(-3),
                        "City Tour", "Plane", 1500.75m, 80, 40, "Experience the Big Apple and its vibrant life.",
                        new DateOnly(2025, 8, 25), 75m, 3, 15m, null, "upcoming", false, DateTime.UtcNow },

                    { 4, 19, 20, new DateOnly(2025, 10, 10), new DateOnly(2025, 10, 20),
                        new DateOnly(2025, 10, 10).ToDateTime(TimeOnly.MinValue).AddDays(-3),
                        "Cultural", "Bus", 1800.00m, 60, 12, "Discover the rich culture and tech in Tokyo.",
                        new DateOnly(2025, 9, 30), 100m, 4, 12m, null, "upcoming", false, DateTime.UtcNow },

                    { 5, 25, 26, new DateOnly(2025, 11, 1), new DateOnly(2025, 11, 10),
                        new DateOnly(2025, 11, 1).ToDateTime(TimeOnly.MinValue).AddDays(-3),
                        "Adventure", "Plane", 2200.00m, 40, 5, "Explore Sydney's beautiful harbor and beaches.",
                        null, null, null, null, null, "upcoming", false, DateTime.UtcNow },

                    { 6, 11, 2, new DateOnly(2025, 7, 15), new DateOnly(2025, 7, 22),
                        new DateOnly(2025, 7, 15).ToDateTime(TimeOnly.MinValue).AddDays(-3),
                        "City Tour", "Bus", 700.00m, 120, 60, "Visit Barcelona's architecture and beaches.",
                        new DateOnly(2025, 7, 5), 30m, 6, 8m, null, "upcoming", false, DateTime.UtcNow },

                    { 7, 22, 23, new DateOnly(2025, 8, 5), new DateOnly(2025, 8, 15),
                        new DateOnly(2025, 8, 5).ToDateTime(TimeOnly.MinValue).AddDays(-3),
                        "Beach", "Bus", 1300.00m, 55, 15, "Sunbathe on Copacabana and experience carnival vibes.",
                        null, null, null, null, null, "upcoming", false, DateTime.UtcNow },

                    { 8, 17, 18, new DateOnly(2025, 9, 20), new DateOnly(2025, 9, 28),
                        new DateOnly(2025, 9, 20).ToDateTime(TimeOnly.MinValue).AddDays(-3),
                        "Nature", "Car", 900.00m, 70, 20, "Explore the mountains and coastlines of Vancouver.",
                        null, null, null, null, null, "upcoming", false, DateTime.UtcNow },

                    { 9, 28, 29, new DateOnly(2025, 10, 25), new DateOnly(2025, 11, 2),
                        new DateOnly(2025, 10, 25).ToDateTime(TimeOnly.MinValue).AddDays(-3),
                        "City Tour", "Train", 1100.00m, 90, 35, "Cycle through historic canals and museums.",
                        new DateOnly(2025, 10, 15), 40m, 7, 9m, null, "upcoming", false, DateTime.UtcNow },

                    { 10, 8, 14, new DateOnly(2025, 12, 5), new DateOnly(2025, 12, 15),
                        new DateOnly(2025, 12, 5).ToDateTime(TimeOnly.MinValue).AddDays(-3),
                        "Fashion", "Plane", 1450.00m, 65, 22, "Milan fashion tour and luxury experience.",
                        new DateOnly(2025, 11, 20), 60m, 3, 11m, null, "upcoming", false, DateTime.UtcNow },
                });
