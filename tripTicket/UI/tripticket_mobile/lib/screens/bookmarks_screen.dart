...
class _BookmarksScreenState extends State<BookmarksScreen> {
  ...
  Future<void> _getBookmarks() async {
    ...
    try {
      var searchResult = await _bookmarksProvider.getBookmarksByUserId(
        AuthProvider.id!,
      );
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    CountryFlag.fromCountryCode(
                                      bookmark.trip.city.country!.countryCode,
                                      height: 12,
                                      width: 18,
                                      shape: const Circle(),
                                    ),
                                ...
                                Text(
                                  _formatDate(bookmark.trip.departureDate),
                                  style: const TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14,
                                    color: Colors.white,
                                ...
                                Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Text(
                                        bookmark.trip.tripStatus.toUpperCase(),
                                        style: const TextStyle(
                                          color: Colors.white,
                                    ...
                                    bookmark.trip.availableTickets > 0
                                        ...
                                        : bookmark.trip.tripStatus == "upcoming"
                                        ? Container(
                                            padding: const EdgeInsets.symmetric(
                                              horizontal: 4,
                                              vertical: 2,
